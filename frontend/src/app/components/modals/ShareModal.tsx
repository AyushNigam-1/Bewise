                    ...
                    >
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2 justify-between ">
                                ...
                                <button
                                    onClick={handleCopy}
                                    className={`p-3 flex items-center justify-center border border-gray-200 dark:border-white/10 flex-shrink-0 rounded-xl font-medium transition-all duration-200 active:scale-95 ${isCopied
