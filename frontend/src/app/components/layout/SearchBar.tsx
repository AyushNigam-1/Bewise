...
const SearchBar = ({
  ...
  return (
    <div
      className={`${responsive ? (maximize ? "w-full absolute left-0 top-2 z-50" : "") : ""} items-center transition-all duration-300`}
    >
      <form
        className={`${responsive ? (maximize ? "" : "hidden md:flex") : "flex"} w-full`}
      >
