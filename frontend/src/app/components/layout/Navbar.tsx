        ...
        <div className="flex items-center gap-2 md:gap-3">
          <Menu as="div" className="relative inline-block text-left">
            <MenuButton
              ...
              className="inline-flex cursor-pointer items-center gap-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100 p-2 md:p-3 text-sm/6 font-semibold rounded-full transition-colors shadow-md"
            >
              <User size={20} />
            </MenuButton>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <div className="relative w-5 h-5 flex items-center justify-center">
                        <Sun
                          size={20}
                          className={`absolute transition-all duration-500 ease-in-out text-gray-500 dark:text-gray-400 ${
                            isDarkMode
                      ...
                      <div className="relative w-24 h-5 flex items-center">
                        <span
                          className={`absolute transition-all duration-300 ease-in-out text-gray-700 dark:text-gray-300 ${isDarkMode ? "opacity-0 translate-y-2" : "opacity-100 translate-y-0"}`}
                        >
                          Light
                        </span>
                        <span
                          className={`absolute transition-all duration-300 ease-in-out text-gray-700 dark:text-gray-300 ${isDarkMode ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-2"}`}
                        >
                          Dark
                        </span>
                      </div>
                    ...
                    <div
                      className={`w-9 h-5 rounded-full flex items-center p-0.5 transition-colors duration-300 ease-in-out ${
                        isDarkMode
                          ? "bg-blue-600"
