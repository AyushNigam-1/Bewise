...
interface InsightCardProps {
    ...
    showActions?: boolean; // 🌟 NEW: Controls whether the footer is rendered
}
...
export const InsightCard = ({
    ...
    onBookmark,
    onShare,
    showActions = true // Default to true for your other pages
}: InsightCardProps) => {
    return (
        <div className="rounded-2xl h-full flex flex-col gap-4 p-4 bg-gray-100 dark:bg-gray-800 transition-colors border border-transparent dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-500">
            <Link
            ...
            >
                ...
                <h4 className='text-gray-800 dark:text-gray-100 font-semibold text-xl md:text-2xl leading-tight line-clamp-2'>
                    {step.step}
                </h4>
                <h6 className='text-gray-600 dark:text-gray-300 mt-auto leading-relaxed line-clamp-3 text-sm'>
                    {step.description}
                </h6>
            </Link>
