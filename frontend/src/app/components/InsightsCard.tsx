...
export const InsightCard = ({ step, bookTitle, isBookmarked, onBookmark, onShare }: InsightCardProps) => {
    return (
        <div className="rounded-2xl h-full flex flex-col gap-4 p-4 bg-gray-100 dark:bg-gray-800 transition-colors border border-transparent dark:border-gray-700">
            <Link
            ...
            >
                ...
                <h6 className='text-gray-600 dark:text-gray-300 mt-auto leading-relaxed line-clamp-4'>
                    {step.description}
                </h6>
            </Link>
